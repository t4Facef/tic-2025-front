...
export default function CompanieForm2() {
    return (
        <form className="flex-col text-start space-y-8">
            ...
            <GenericFormField id="companie_email_register" type="email" placeholder="Digite aqui o e-mail corporativo" autoComplete="email">E-mail Corporativo</GenericFormField>
            <div className="flex space-x-24">
                <GenericFormField id="companie_telefone_register" placeholder="Digite aqui o telefone comercial" autoComplete="tel">Telefone Comercial</GenericFormField>
                    ...
                    <div className="w-[30rem] space-y-5">
                        ...
                        <div className="flex flex-1 space-x-5">
                            <div className="flex-[3] w-full">
                                <GenericFormField id="companie_estado_register" type="select" options={['Selecione']}>Estado</GenericFormField>
                            </div>
                            <div className="flex-[7] w-full">
                                <GenericFormField id="companie_cidade_register" type="select" options={['Selecione']}>Cidade</GenericFormField>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-1 justify-between space-x-16">
                        <div className="flex flex-col w-full flex-[7] space-y-5">
                            <GenericFormField id="companie_rua_register" placeholder="Digite aqui a rua" autoComplete="address-line1">Rua</GenericFormField>
                        ...
                        <div className="flex flex-col w-full flex-[2] space-y-5">
                            <GenericFormField id="companie_bairro_register" placeholder="Digite aqui o bairro" autoComplete="address-level2">Bairro</GenericFormField>
                            <GenericFormField id="companie_numero_register" placeholder="Digite aqui o número">Número</GenericFormField>
                        </div>
                    </div>
                </div>
            </div>

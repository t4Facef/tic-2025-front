...
export default function CandidateForm1 (){
    return (
        <form className="flex-col text-start space-y-8">
            ...
            <GenericFormField id="candidate_name_register" type="text" placeholder='Digite aqui o seu nome completo' autoComplete="name">Nome completo</GenericFormField>
            <div className="flex justify-between space-x-16">
                <GenericFormField id="candidate_cpf_register" type="text" placeholder='Digite aqui seu CPF'>CPF</GenericFormField>
                <GenericFormField id="candidate_birth_date_register" type="date" autoComplete="bday">Data de Nascimento</GenericFormField>
            </div>
            <div className="flex justify-between space-x-16">

...
export default function Adaptation() {
  return (
    <div className="px-4 md:px-20 py-6 md:py-10">
      <h1 className="font-bold text-xl md:text-[2rem] italic">Processo de Adequação</h1>
      ...
      <div className="mt-6 md:mt-10">
        <h2 className="font-bold text-lg md:text-[1.5rem] italic">Como se cadastrar para Candidatos:</h2>
        <p className="mt-2">
      ...
      <div className="mt-6 md:mt-10">
        <h2 className="font-bold text-lg md:text-[1.5rem] italic">Como se cadastrar para Empresas:</h2>
        <p className="mt-2">
      ...
      <div className="mt-6 md:mt-10 items-end flex w-full flex-col">

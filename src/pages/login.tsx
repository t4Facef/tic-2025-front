...
export default function Login() {
    ...
    return (
        <div className="flex justify-center text-blue3 px-4">
            <div className="w-full max-w-md my-8 md:my-12">
                ...
                <div className="bg-blue1 rounded-b-lg">
                    <div className="flex flex-col gap-6 md:gap-8 justify-center py-4 md:py-6 px-6 md:px-16">
                        <form className="flex flex-col w-full space-y-3 md:space-y-4" onKeyDown={(e) => {
                            if (e.key === 'Enter') {
                                e.preventDefault()
                            ...
                            <div className="flex flex-col sm:flex-row sm:justify-between text-sm py-1 md:py-2 gap-2">
                            ...
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end pt-6 md:pt-12 gap-4">

    ...
    <div className="m-20 bg-blue1 border border-black rounded-lg">
      ...
      <div className="flex flex-col justify-center items-center py-8 space-x-8 my-8 space-y-12">
        <div className="flex flex-row ">
          <button className="bg-blue3 rounded-l-xl p-16 space-x-5 hover:bg-blue3H transition-colors" onClick={() => navigate("/auth/register/candidates")}>
          ...
          <button className="bg-blue5 rounded-r-xl p-16 hover:bg-blue5H transition-colors" onClick={() => navigate("/auth/register/companies")}>

        ...
        <div>
            <section className="relative w-full h-[500px] bg-cover bg-center" style={{ backgroundImage: "url('/img/homepage/home-page-img1.jpg')" }}>
                ...
                <div className="relative z-10 flex items-center justify-center h-full px-2 sm:px-4 md:px-8">
                    <div className="bg-blue1 bg-opacity-90 rounded-xl shadow-lg p-6 sm:p-8 md:p-10 max-w-7xl flex flex-1">
                        ...
                        <div className="flex-[3] flex justify-between flex-col">
                            ...
                            <div className="flex justify-end items-end">
                                <GenericBlueButton color={3} link='/saiba_mais'>Conheça Mais Sobre</GenericBlueButton> 
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex flex-col px-8 items-center">
                <div className="flex flex-col items-end">
                    ...
                    <div className="my-6">
                        <GenericBlueButton color={3} link="/">Registre-se Agora!</GenericBlueButton>
                    </div>
                </div>
            </div>
        </div>
